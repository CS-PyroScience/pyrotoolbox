...
class AquapHOx_403(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "AQUACULT",
                "experiment_description": "",
                "device": "AquapHOx L1",
                "uid": "24967102575BA4F1",
                "firmware": "403:1",
                "software_version": "Firmware 403:1",
                "channel": "1",
                "settings": {
                    "temperature": "external sensor",
                    "pressure": 1013.0,
        ...
        self.assertDictEqual(
            {
                ...
                "oxygen_µM": 199.918,
                "oxygen_hPa": 197.116,
                "oxygen_%airsat": 96.038,
                "sample_temperature": 25.841,
                "case_temperature": 26.38,
                "signal_intensity": 467.036,
                "ambient_light": 1.002,
                "pressure": 1078.841,
                "humidity": 19.332,
                "oxygen_%O2": 19.458,
...
class AquapHOx_405(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "wsee2",
                "experiment_description": "",
                "device": "AquapHOx-LX",
                "uid": "24EB9B04575BA4FC",
                "firmware": "405:3",
                "software_version": "Firmware 405:3",
                "channel": "1",
                "settings": {
                    "temperature": "external sensor",
                    "pressure": 1013.0,
        ...
        self.assertDictEqual(
            {
                "status": 0.0,
                "dphi": 35.158,
                "sample_temperature": 28.524,
                "case_temperature": 24.6,
                "signal_intensity": 466.722,
                "ambient_light": 26.979,
                "pressure": 971.262,
                "humidity": 36.973,
                "pH": 7.298,
                "ldev": 622.94,
    ...
    def test_load_f2(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "ULVIK29S",
                "experiment_description": "",
                "device": "AquapHOx-L-pH",
                "uid": "24E4C301575BA56A",
                "firmware": "405:3",
                "software_version": "Firmware 405:3",
                "channel": "1",
                "settings": {
        ...
        self.assertDictEqual(
            {
                "status": 0.0,
                "dphi": 28.738,
                "sample_temperature": 20.207,
                "case_temperature": 12.57,
                "signal_intensity": 165.73,
                "ambient_light": 3.765,
                "pressure": 995.552,
                "humidity": 36.956,
                "pH": 7.997,
...
class AquapHOx_410(unittest.TestCase):
    ...
    def test_load_f2(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "AFNETZ",
                "experiment_description": "Neue_anti_fouling_folie_fox484_mit_innerem_und_äußeren_netz",
                "device": "AquapHOx-L-O2",
                "uid": "24C53407596FCADA",
                "firmware": "410:5",
                "software_version": "Firmware 410:5",
                ...
                "calibration": {
                    ...
                    "mt": -0.000303,
                    "percentO2": 20.95,
                    "date_calibration_high": datetime.datetime(2023, 8, 17, 13, 42),
        ...
        self.assertDictEqual(
            {
                ...
                "oxygen_µM": -0.084,
                "oxygen_hPa": -0.086,
                "oxygen_%airsat": -0.042,
                "sample_temperature": 28.672,
                "case_temperature": 30.26,
                "signal_intensity": 603.79,
                "ambient_light": 3.753,
                "pressure": 1042.969,
                "humidity": 27.794,
                "oxygen_%O2": -0.008,
    ...
    def test_load_f3(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "563OHNE",
                "experiment_description": "pk8_mit_zineb_563_ohne_Kupfer_Netz",
                "device": "AquapHOx-LX",
                "uid": "2411E505575BA512",
                "firmware": "410:5",
                "software_version": "Firmware 410:5",
                "channel": "1",
                "settings": {
        ...
        self.assertDictEqual(
            {
                "status": 0.0,
                "dphi": 55.082,
                "sample_temperature": 29.644,
                "case_temperature": 30.69,
                "signal_intensity": 299.555,
                "ambient_light": 35.038,
                "pressure": 986.342,
                "humidity": 34.106,
                "pH": 10.995,
                "R": 0.055965,
    ...
    def test_load_f4(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "pH1Rov",
                "experiment_description": "pK8T_std_ohne_Cu_Netz_Rov_start_0904",
                "device": "AquapHOx-LX",
                "uid": "24967102575BA4F1",
                "device_serial": "0",
                "firmware": "410:6",
                "software_version": "Firmware 410:6",
                "channel": "1",
                "settings": {
                    "temperature": "external sensor",
                    "pressure": "internal sensor",
                ...
                "calibration": {
                    ...
                    "pka_is1": 0.97,
                    "pka_is2": 0.126,
                    "date_calibration_acid": datetime.datetime(2024, 4, 8, 13, 35),
                    "date_calibration_base": datetime.datetime(2024, 4, 8, 13, 41),
                    "date_calibration_offset": None,
                },
                "sensor_code": "FID7-867-931",
            },
            {k: v for k, v in m.items() if k != "parser_version"},
        )
        self.assertEqual(
        ...
        self.assertDictEqual(
            {
                ...
                "dphi": 53.939,
                "sample_temperature": 25.841,
                "case_temperature": 27.11,
                "signal_intensity": 234.234,
                "ambient_light": 29.447,
                "pressure": 981.114,
                "humidity": 29.716,
                "pH": 9.658,
                "R": 0.0823,
