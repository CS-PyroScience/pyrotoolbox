...
class TestWorkbench_1_0_20(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "Ecoli_AllSensors_FireStingPro1905171DO2pH3Temp",
                "experiment_description": "",
                "software_version": "Workbench V1.0.20",
                "device": "FireSting pro [A] FSPLUS-4",
                "device_serial": "",
                "uid": "2466C2065AC97E6E",
                "firmware": "4.01:007",
                "channel": 1,
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2019, 5, 17, 0, 0),
    ...
    def test_load_f4(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "Ecoli_AllSensors_FireStingPro",
...
class TestWorkbench_1_0_24(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "20190521_Klimaschrank_PK7",
                ...
                "software_version": "Workbench V1.0.24",
                "device": "FireSting pro [A] FSPLUS-4",
                "device_serial": "",
                "uid": "249BC3015AC980E1",
                "firmware": "4.01:007",
                "channel": 1,
                "sensor_code": "SAD7-255-050",
                "settings": {
                    "duration": "64 ms",
                    "intensity": "30%",
                    "amp": "400x",
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2019, 5, 21, 0, 0),
...
class TestWorkbench_1_0_28(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "KK393_pyroscience_Ferm_DX_py_1",
                "experiment_description": "\n",
                "software_version": "Workbench V1.0.28",
                "device": "FireSting pro [A] FSPLUS-4",
                "device_serial": "",
                "uid": "2466C2065AC97E4B",
                "firmware": "4.01:008",
                "channel": 1,
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2019, 4, 6, 0, 0),
...
class TestWorkbench_1_0_1_808(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "testlog",
                "experiment_description": "\n",
                "software_version": "Workbench V1.0.1.808",
                "device": "FireSting pro [A] FSPLUS-4",
                "device_serial": "",
                "uid": "2466C2065AC9A991",
                "firmware": "4.02:002",
                "channel": 1,
                "sensor_code": "SAG7-505-050",
                "settings": {
                    "duration": "16 ms",
                    "intensity": "40%",
                    "amp": "400x",
        ...
        self.assertEqual(
            ["time_s", "pH", "dphi", "signal_intensity", "ambient_light", "ldev", "status", "case_temperature"],
            list(df.columns),
        )
...
class TestWorkbench_1_0_2_830(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "KK399_PyroSci pH Eval 3rd pH4",
                "experiment_description": "\n",
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2019, 11, 28, 0, 0),
        ...
        self.assertEqual(
            ["time_s", "pH", "dphi", "signal_intensity", "ambient_light", "ldev", "status", "sample_temperature"],
            list(df.columns),
        )
...
class TestWorkbench_1_2_0_1289(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "2020-11-04 ApHOx PK8T Precisio",
                ...
                "software_version": "Workbench V1.2.0.1289",
                "device": "AquapHOx-LX Nr8 [A] APHOX-LX",
                "device_serial": "",
                "uid": "24967102575BA4F1",
                "firmware": "4.03:004",
                "channel": 1,
                "sensor_code": "FCB7-390-783",
                "settings": {
                    "duration": "16 ms",
                    "intensity": "15%",
                    "amp": "400x",
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2020, 11, 5, 0, 0),
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2021, 7, 7, 0, 0),
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    "date_calibration_high": datetime.datetime(2022, 11, 16, 0, 0),
...
class TestWorkbench_1_4_7_2305(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "Startmessung in Sulfit",
                "experiment_description": "ch1+2: referenz f404\nch3+4: neues tio2 f440\n",
                "software_version": "Workbench V1.4.7.2305",
                "device": "FireSting-PRO [A] FSPRO-4",
                "device_serial": "",
                "uid": "24EB9B03596FD090",
                "firmware": "4.11:001",
                "channel": 1,
                "sensor_code": "SA6-500-200",
                "settings": {
                    "duration": "8 ms",
                    "intensity": "10%",
                    "amp": "200x",
...
class TestWorkbench_1_4_8_2380(unittest.TestCase):
    ...
    def test_load_f3(self):
        ...
        self.assertEqual(
            ["time_s", "optical_temperature", "dphi", "signal_intensity", "ambient_light", "status"], list(df.columns)
        )
        ...
        self.assertEqual(
            {
                ...
                "settings": {
                    ...
                    "pressure": "internal sensor",
                    "salinity": 7.500000,
                    "temperature": "Optical Temperature Sensor on Channel 3",
                    "write_lock": False,
                },
                "software_version": "Workbench V1.4.8.2380",
                "uid": "24EB9B03596FC737",
...
class TestWorkbench_1_5_0_2415(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "100µlmin pH MFTC",
                "experiment_description": "pH 6.5, pH 7, pH7.5, pH8, pH6\n",
                "software_version": "Workbench V1.5.0.2415",
                "device": "FSP1 [A] FSPRO-4",
                "device_serial": "0",
                "uid": "243B1F055AC97A89",
                "firmware": "4.11:001",
                "channel": 1,
                "sensor_code": "SGE7-527-445",
                "settings": {
                    "duration": "16 ms",
                    "intensity": "40%",
                    "amp": "400x",
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2024, 8, 1, 0, 0),
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    "date_calibration_offset": datetime.datetime(2024, 8, 1, 0, 0),
                    "M": 273.0,
                    "N": 522.0,
                    "C": 0.097,
                    "temp_offset": 0.583533,
                    "bkgdAmpl": 0.584,
                    "bkgdDphi": 0.0,
                },
            },
...
class TestWorkbench_1_5_3_2466(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "air_percentO2",
                "experiment_description": "\n",
                "software_version": "Workbench V1.5.3.2466",
                "device": "FSP23 [A] FSPRO-4",
                "device_serial": "20460041",
                "uid": "249BC3015AC9AE27",
                "firmware": "4.11:001",
                "channel": 1,
                ...
                "calibration": {
                    "date_calibration_high": datetime.datetime(2024, 9, 3, 0, 0),
                    "date_calibration_zero": None,
                    "dphi100": 21.024534,
                    "dphi0": 53.0,
                    "f": 0.804,
        ...
        self.assertDictEqual(
            {
                ...
                "oxygen_%O2": 20.712,
                "dphi": 21.024,
                "signal_intensity": 321.0,
                "ambient_light": 0.0,
                "status": 0.0,
                "sample_temperature": 25.526,
                "pressure": 974.0,
            },
    ...
    def test_load_f8(self):
        ...
        self.assertDictEqual(
            {
                "time_s": 1.94,
                "oxygen_µg/L": 7181.952,
                "dphi": 21.081,
                "signal_intensity": 321.0,
                "ambient_light": 0.0,
                "status": 0.0,
                "sample_temperature": 25.594,
                "pressure": 1013.0,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        )
    ...
    def test_load_f9(self):
        ...
        self.assertDictEqual(
            {
                "time_s": 1.28,
                "oxygen_%airsat": 96.942,
                "dphi": 21.091,
                "signal_intensity": 321.0,
                "ambient_light": 0.0,
                "status": 0.0,
                "sample_temperature": 25.592,
                "pressure": 974.0,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        )
...
class TestWorkbench_1_5_4_2482(unittest.TestCase):
        ...
        self.assertEqual(
            {
                ...
                "device": "FireSting-PRO [A] FSPRO-4",
                "device_serial": "23390005",
                "uid": "241642085AC9AE27",
                "firmware": "4.11:001",
                "channel": 1,
                ...
                "settings": {
                    ...
                    "pressure": "internal sensor",
                    "salinity": 7.5,
                    "fiber_length_mm": 2000,
                },
                "calibration": {
                    "date_calibration_high": datetime.datetime(2025, 3, 24, 0, 0),
        ...
        self.assertDictEqual(
            {
                ...
                "oxygen_hPa": 206.078,
                "dphi": 21.834,
                "signal_intensity": 176.0,
                "ambient_light": 0.0,
                "status": 0.0,
                "sample_temperature": 24.279,
                "pressure": 994.0,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        )
    ...
    def test_load_f2(self):
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    "date_calibration_offset": datetime.datetime(2025, 3, 24, 0, 0),
                    "M": 316.0,
                    "N": 543.0,
                    "C": 0.097,
                    "temp_offset": 0.261797,
                    "bkgdAmpl": 0.584349,
                    "bkgdDphi": 0.0,
                },
            },
        ...
        self.assertDictEqual(
            {
                "time_s": 1.177,
                "optical_temperature": 24.295,
                "dphi": 41.43,
                "signal_intensity": 240.0,
                "ambient_light": 0.0,
                "status": 0.0,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    "date_calibration_acid": datetime.datetime(2025, 3, 24, 0, 0),
        ...
        self.assertDictEqual(
            {
                ...
                "pH": 7.177,
                "dphi": 36.422,
                "signal_intensity": 105.0,
                "ambient_light": 0.0,
                "R": 0.642,
                "status": 0.0,
                "sample_temperature": 24.283,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        )
    ...
    def test_load_f4(self):
        ...
        self.assertDictEqual(
            {
                "time_s": 1.373,
                "oxygen_%airsat": 97.897,
                "dphi": 21.781,
                "signal_intensity": 245.0,
                "ambient_light": 1.0,
                "status": 0.0,
                "sample_temperature": 24.278,
                "pressure": 994.0,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        )
