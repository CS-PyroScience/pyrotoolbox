...
class Firmware_336(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "experiment_name": "LOG026",
                "experiment_description": "",
                "device": "FireStingGO2_Pocket_Oxygen_Meter",
                "firmware": "3.36",
                "uid": "24C53408575BA6A3",
...
class Firmware_339(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertDictEqual(
            {
                "oxygen_mgL": np.nan,
                "sample_temperature": 26.49,
                "pressure": 1002.2,
                "humidity": 44.7,
                "time_s": 2.0,
                "status": 2.0,
                "dphi": -180.0,
                "signal_intensity": 0.6,
                "ambient_light": 0.0,
        ...
        self.assertEqual(
            {
                ...
                "calibration": {
                    ...
                    "mt": -0.000301,
                    "percentO2": 20.95,
                    "date_calibration_high": datetime.datetime(2024, 8, 27, 0, 0),
                    "date_calibration_zero": None,
                },
                "sensor_code": "ZA6-520-204",
            },
            {k: v for k, v in m.items() if k != "parser_version"},
        )
        self.assertEqual(
        ...
        self.assertDictEqual(
            {
                ...
                "status": 32.0,
                "dphi": 21.053,
                "signal_intensity": 150.3,
                "ambient_light": 7.6,
                "case_temperature": 26.16,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
        )
