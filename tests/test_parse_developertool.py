...
class TestDeveloperTool_v150(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv150\t(c) 2021 by\tPyroScience GmbH",
...
class TestDeveloperTool_v155(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv155\t(c) 2022 by\tPyroScience GmbH",
                "experiment_name": "FSP20 247AA5035D64A770 2022-08-16 09'37'46 Ch1.txt",
                "experiment_description": "",
                "device": "FSP20",
        ...
        self.assertDictEqual(
            {
                ...
                "pH": np.nan,
                "pressure": 969.176,
                "signal_intensity": 369.73,
                "status": 32.0,
                "case_temperature": 28.031,
...
class TestDeveloperTool_v157(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv157\t(c) 2022 by\tPyroScience GmbH",
                "experiment_name": "PICO-OEM 2491CB0658B63D92 2022-11-15 14'54'09 Ch1.txt",
                "experiment_description": "",
                "device": "PICO-OEM",
                "uid": "2491CB0658B63D92",
                "firmware": "405:2",
                "channel": "1",
                "settings": {
                    "temperature": "external sensor",
        ...
        self.assertDictEqual(
            df.iloc[1].to_dict(),
            {
                ...
                "oxygen_%O2": -22.664,
                "pressure": 0.0,
                "signal_intensity": 427.371,
                "status": 0.0,
                "case_temperature": 25.908,
                "sample_temperature": 23.83,
                "oxygen_µM": -281.975,
                "time_s": 0.974,
            },
        )
...
class TestDeveloperTool_v158(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv158\t(c) 2022 by\tPyroScience GmbH",
                "experiment_name": "FireSting-PRO 24EB9B03596FD517 2023-03-15 09'29'46 Ch1.txt",
                "experiment_description": "",
                "device": "FireSting-PRO",
                "uid": "24EB9B03596FD517",
                "firmware": "411:1",
                "channel": "1",
                "settings": {
                    "temperature": "external sensor",
        ...
        self.assertDictEqual(
            {
                ...
                "oxygen_%O2": -0.713,
                "pressure": 968.737,
                "signal_intensity": 1659.394,
                "status": 1.0,
                "case_temperature": 9.648,
                "sample_temperature": 23.735,
                "oxygen_µM": -8.482,
                "time_s": 4.956,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
    ...
    def test_load_f2(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv158\t(c) 2022 by\tPyroScience GmbH",
                "experiment_name": "FSP15 249BC3015AC980E1 2024-05-23 15'12'14 Ch1.txt",
                "experiment_description": "",
                "device": "FSP15",
        ...
        self.assertDictEqual(
            {
                "comment": np.nan,
                "R": 1.8122539999999998,
                "ambient_light": 0.068,
                "dphi": 18.174,
                "humidity": 36.982,
                "pH": np.nan,
                "pressure": 973.338,
                "signal_intensity": 1006.95,
                "status": 32.0,
                "case_temperature": 26.953,
                "sample_temperature": np.nan,
                "time_s": 1.001,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
...
class TestDeveloperTool_v162(unittest.TestCase):
    ...
    def test_load_f1(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv162\t(c) 2023 by\tPyroScience GmbH",
        ...
        self.assertDictEqual(
            {
                ...
                "oxygen_%O2": np.nan,
                "pressure": 970.921,
                "signal_intensity": 1.059,
                "status": 34.0,
                "case_temperature": 28.468,
                "sample_temperature": np.nan,
                "oxygen_µM": np.nan,
                "time_s": 0.976,
            },
    ...
    def test_load_f2(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv162\t(c) 2023 by\tPyroScience GmbH",
                "experiment_name": "FSP39 24EB9B03596FC737 2024-07-01 13'42'41 Ch2.txt",
                "experiment_description": "",
                "device": "FSP39",
                "uid": "24EB9B03596FC737",
                "firmware": "411:1",
        ...
        self.assertDictEqual(
            {
                "comment": np.nan,
                "R": 11.285887,
                "ambient_light": 55.488,
                "dphi": -175.978,
                "humidity": 49.599,
                "pH": np.nan,
                "pressure": 970.94,
                "signal_intensity": 0.636,
                "status": 34.0,
                "case_temperature": 28.398,
                "sample_temperature": np.nan,
                "time_s": 0.98,
            },
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[1].to_dict().items()},
    ...
    def test_load_f4(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv162\t(c) 2023 by\tPyroScience GmbH",
                "experiment_name": "FSP39 24EB9B03596FC737 2024-07-01 13'42'41 Ch4.txt",
                "experiment_description": "",
                "device": "FSP39",
                "uid": "24EB9B03596FC737",
                "firmware": "411:1",
    ...
    def test_load_trox(self):
        ...
        self.assertEqual(
            {
                "software_version": "PyroSimpleLogger\tv162\t(c) 2023 by\tPyroScience GmbH",
                "experiment_name": "Scheitt 4 neue Ch1.txt",
                "experiment_description": "",
                "device": "FSP1",
                "uid": "243B1F055AC97A89",
                "firmware": "411:1",
                ...
                "calibration": {
                    ...
                    "date_calibration_zero": datetime.datetime(2025, 4, 10, 12, 38),
                },
            },
            m,
        )
        ...
        self.assertDictEqual(
            {k: np.nan if np.isnan(v) else v for k, v in df.iloc[10].to_dict().items()},
            {
                "comment": np.nan,
                "oxygen_%airsat": 99.817568,
                "ambient_light": -0.168,
                "dphi": 6.854,
                "humidity": 24.864,
                "oxygen_hPa": 198.645552,
                "oxygen_%O2": 20.318076,
                "pressure": 977.679,
                "signal_intensity": 266.114,
                "status": 64.0,
                "case_temperature": 27.328,
                "sample_temperature": 22.802,
                "oxygen_µM": 247.52078400000002,
                "time_s": 10.02,
            },
        )
        self.assertTrue(df.index.is_monotonic_increasing)
